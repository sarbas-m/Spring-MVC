...
<body>
	...
	<button  class="btn btn-primary" id="logoutButtons">
		...
		<div class="content">
			<h1>WELCOME TO PHARMACIST </h1>
			<p>We"ll Always Make Time For You</p>
			<div>
				<button>
					<span></span><a href="<%=request.getContextPath()%>/medicine/showFormAdd">ADD MEDICINE</a>
				</button>
				<button>
					<span></span><a href="<%=request.getContextPath()%>/medicine/lists">LIST MEDICINE</a>
				</button>
				<button>
					<span></span><a href="<%=request.getContextPath()%>/company/showFormCom">ADD COMPANY</a>
				</button>
				<br>
				<button>
					<span></span><a href="<%=request.getContextPath()%>/company/listt">LIST COMPANY</a>
				</button>
				<button>
					<span></span><a href="<%=request.getContextPath()%>/prescription/showPris">VIEW PRESCRIPTION</a>
				</button>
				<button>
					<span></span><a href="<%=request.getContextPath()%>/order/showOrder">REORDER MEDICINE</a>
				</button>
			</div>
		</div>
	</div>
