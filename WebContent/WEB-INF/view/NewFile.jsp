	...
	<button  class="btn btn-primary" id="logoutButton">
		...
		<div class="content">
			...
			<div>
				...
				<p>Welcome Doctor ${staffName}</p>

				<c:url var="appointment"
					value="${pageContext.request.contextPath}/doctorSarbas/listAppoinmenet">
					<c:param name="userId" value="${userId}"></c:param>
				</c:url>
				<button><span></span>
				<a
					href="${pageContext.request.contextPath}/doctorSarbas/listAppoinmenet?userId=${userId}">Doctor
					Management </a>
					</button>
</div>
</div>
