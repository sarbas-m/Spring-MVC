...
<h1>WELCOME TO LAB TECHNICIAN SLOT</h1>
<h6>We'll Always Make Time For You</h6>

<button><span></span><a href="${pageContext.request.contextPath}/test/listTest">LIST TEST</a></button>
<button><span></span><a href="${pageContext.request.contextPath}/patientview/patientfortest">VIEW PATIENT LIST</a></button>
<button><span></span><a href="${pageContext.request.contextPath}/report/listofreports">VIEW REPORT</a></button>
